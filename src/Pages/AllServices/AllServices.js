...
const AllServices = () => {
    ...
    useEffect(() => {
        fetch('https://doctor-service-server-atique-atq.vercel.app/services')
            .then(res => res.json())
            .then(data => {
                setServices(data);
        ...
        <div>
            {
                loadingServices &&
                <div role="status">
                    <svg aria-hidden="true" className="ml-20 mr-2 w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className='ml-20'>Loading...</span>
                </div>
            }
